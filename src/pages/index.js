          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center  self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="https://drive.google.com/file/d/1cPM3m4Aiyvbv-g1gsGzoSzF3dnjDauKZ/view?usp=drivesdk"
                  target={"_blank"}
  ...
  <div className="flex items-center justify-between w-full lg:flex-col">
    <div className="w-1/2 lg:w-full flex justify-center items-center">
      <Image
        ...
        sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 50vw"
        alt="home-image"
        className="w-full h-auto max-w-[500px] md:max-w-[400px] sm:max-w-[300px]"
      />
    </div>
    <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center mt-6 lg:mt-10">
      <AnimatedText
        className="!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md:!text-5xl sm:!text-3xl"
        text="Turning Vision Into Reality With Code And Design."
      />
